...
@CucumberOptions(plugin = { "pretty:target/cucumber/cucumber.txt",
		...
		"com.devaura.qa.utils.TestListener" }, features = "resources/cucumbers/create_booking.feature", glue = "com.devaura.qa.definitions", monochrome = true, snippets = CAMELCASE
