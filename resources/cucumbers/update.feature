Feature: To update a booking in restful-booker
  ...
  Scenario Outline: To update a booking using JSON data
    ...
    Examples: 
      ...
      | upd-booking-0007 | update-object-file.json |
      | upd-booking-0008 | update-object-file.json |
      | upd-booking-0009 | update-object-file.json |
      | upd-booking-0010 | update-object-file.json |
      | upd-booking-0011 | update-object-file.json |
      | upd-booking-0012 | update-object-file.json |
      | upd-booking-0013 | update-object-file.json |
      | upd-booking-0014 | update-object-file.json |
      | upd-booking-0015 | update-object-file.json |
      | upd-booking-0016 | update-object-file.json |
      | upd-booking-0017 | update-object-file.json |
      | upd-booking-0018 | update-object-file.json |
      | upd-booking-0019 | update-object-file.json |
      | upd-booking-0020 | update-object-file.json |
      | upd-booking-0021 | update-object-file.json |
      | upd-booking-0022 | update-object-file.json |
      | upd-booking-0023 | update-object-file.json |
      | upd-booking-0024 | update-object-file.json |
      | upd-booking-0025 | update-object-file.json |
      | upd-booking-0026 | update-object-file.json |
      | upd-booking-0027 | update-object-file.json |
      | upd-booking-0028 | update-object-file.json |
      | upd-booking-0029 | update-object-file.json |
      | upd-booking-0030 | update-object-file.json |
      | upd-booking-0031 | update-object-file.json |
      | upd-booking-0032 | update-object-file.json |
      | upd-booking-0033 | update-object-file.json |
      | upd-booking-0034 | update-object-file.json |
      | upd-booking-0035 | update-object-file.json |
      | upd-booking-0036 | update-object-file.json |
      | upd-booking-0037 | update-object-file.json |
      | upd-booking-0038 | update-object-file.json |
      | upd-booking-0039 | update-object-file.json |
      | upd-booking-0040 | update-object-file.json |
      | upd-booking-0041 | update-object-file.json |
      | upd-booking-0042 | update-object-file.json |
      | upd-booking-0043 | update-object-file.json |
      | upd-booking-0044 | update-object-file.json |
      | upd-booking-0045 | update-object-file.json |
      | upd-booking-0046 | update-object-file.json |
      | upd-booking-0047 | update-object-file.json |
      | upd-booking-0048 | update-object-file.json |
      | upd-booking-0049 | update-object-file.json |
      | upd-booking-0050 | update-object-file.json |
